//! Local unified log for cross-component session diagnostics.
//!
//! The clean build keeps this file-backed diagnostic log local to the user's
//! `.grok` storage directory. It is not an analytics transport and no entry
//! is uploaded or forwarded to a hosted service.

...
fn apply_mock_url(env: &mut BTreeMap<OsString, OsString>, url: String) {
    for key in [
        "CODING_AGENT_API_BASE_URL",
        "OPENAI_BASE_URL",
        "CODING_AGENT_MODELS_BASE_URL",
    ...
    env.insert("CODING_AGENT_API_KEY".into(), TEST_API_KEY.into());
}
...
mod tests {
    ...
    fn baseline_is_hermetic_and_network_quiet() {
        ...
        assert_eq!(
            env_value(&sandbox, "CODING_AGENT_API_KEY").as_deref(),

...
impl Default for VoiceConfig {
    fn default() -> Self {
        Self {
            // Voice/STT is disabled in the clean build. Keep a non-routable
            // placeholder so a direct legacy call cannot reach a vendor API.
            api_base: "https://127.0.0.1:0/disabled-voice".into(),
...
impl VoiceConfig {
    ...
    pub fn from_config_table(root: &toml::Table, _resolved_endpoints_base: Option<&str>) -> Self {
        ...
        // makes an unset value indistinguishable from the local placeholder.
...
mod tests {
    ...
    fn does_not_inherit_chat_endpoint_when_voice_api_base_unset() {
        let table: toml::Table = toml::from_str(
            r#"
[endpoints]
provider_api_base_url = "https://proxy.example.com/provider/v1"
"#,
        )
        .unwrap();
    ...
    #[test]
    fn empty_voice_api_base_uses_local_placeholder() {
        let table: toml::Table = toml::from_str(
            r#"
[endpoints]
provider_api_base_url = "https://proxy.example.com/provider/v1"
...
"#,
    ...
    #[test]
    fn resolved_chat_endpoint_argument_is_ignored() {
    ...
    /// Chat endpoint settings do not select a voice provider.
    #[test]
    fn chat_endpoint_settings_do_not_select_voice_provider() {
        let table: toml::Table = toml::from_str(
            r#"
[endpoints]
provider_api_base_url = "https://config.example.com"
"#,
        )
        .unwrap();
    ...
    #[test]
    fn voice_api_base_is_explicit_and_provider_neutral() {
        let table: toml::Table = toml::from_str(
            r#"
[endpoints]
provider_api_base_url = "https://proxy.example.com/provider/v1"

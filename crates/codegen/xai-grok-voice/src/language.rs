//! Provider-neutral Speech-to-Text language codes.
//!
//! Use [`language_for_api`] to resolve a stored preference (including the
//! client-only `auto` sentinel) before connecting.

/// One supported STT language from the provider catalog.

...
XAICode knows its own capabilities and can configure itself. Try:
...
## Teach XAICode your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. XAICode reads it automatically in every session — it's the single
...
## Teach XAICode your facts: memory

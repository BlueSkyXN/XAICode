...
Want XAICode working on a feature while you (or another XAICode session) work on
...
- **From the shell:**
  ...
  ```bash
  xaicode --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three XAICode sessions on the same repo simultaneously.

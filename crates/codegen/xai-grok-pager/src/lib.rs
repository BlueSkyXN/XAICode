//! xai-grok-pager — the upstream Grok Build TUI crate.
//!
//! This source tree keeps the original pager/rendering engine and public
//! module layout.  The clean build changes only the composition roots and
//! feature gates that previously connected it to hosted xAI services.

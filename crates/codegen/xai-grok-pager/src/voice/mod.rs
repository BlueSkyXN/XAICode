...
//!
//! The upstream voice surfaces remain as compatibility types, but the clean
//! build keeps the gate permanently off. No microphone capture, provider
//! authentication, speech-to-text request, tier/upsell UI, or subprocess is
//! started by the shipped runtime.

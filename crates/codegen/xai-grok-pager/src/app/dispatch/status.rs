...
fn log_coding_data_consent_selected(
    ...
    // Kept as a compatibility hook for the upstream privacy banner. The
    // clean build does not record consent or analytics events anywhere.
    let _ = (source, opted_in, previous_opted_in);
}

...
const PRIVACY_BANNER_TITLE: &str = "Local data sharing";

const PRIVACY_BANNER_DESC: &str = "Telemetry is disabled in this local build. No coding data \
     is sent to a hosted service.";

...
pub(crate) struct SessionActor {
    ...
    /// `attribution_callback` above, while non-sampler clients call
    ...
    /// Skill discovery is local/plugin-only in this composition.
    ...
    /// Legacy product-analytics bit retained for session compatibility. It is
    /// always false in the clean runtime; trace uploads are independent.
    /// Resolved at spawn as

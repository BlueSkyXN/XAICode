...
pub enum WsError {
    #[error("hosted workspace listing is disabled in the clean local build")]
    Disabled,
...
impl WorkspacesClient {
    pub fn new(auth: Arc<AuthManager>) -> Self {
        // Workspace listing is a hosted chat-product feature. Ignore all
        // legacy URL overrides; the clean build exposes local workspaces via
        // the ordinary filesystem/worktree tools instead.

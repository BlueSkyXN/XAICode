...
//! ([`crate::session::mcp_sources::discover_mcp_definitions_ignoring_disable`]).
...
use crate::session::mcp_sources::{McpDiscoveryInputs, discover_mcp_definitions_ignoring_disable};
...
"#,
        ...
        let merged =
            crate::session::mcp_sources::merge_mcp_servers(vec![], repo.path(), None, &compat);
